...
E compiled_main(){
    ...
    // Variable t52 has type H_I and len 57069
    ...
    // getInfoVar(t160);
    // Variable t160 has type H_G and len 7
    //   H_I H_Q H_E H_S H_Q H_S H_S
    //   total = 7, max = 114705, min = 114705
    // Variable t134 has type H_L and len 114705
    PROFILE( 61, t161, pfnGroup(t161, t160));
    PROFILE( 62, t162, pfnKeys(t162, t161));
    // getInfoVar(t162); getchar();
    // Variable t162 has type H_L and len 37967
