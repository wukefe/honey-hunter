...
L q17_loopfusion_1(V z, V *x){
    ...
    // Variable x0 has type H_L and len 204
    // Variable x1 has type H_E and len 204
    // Variable x2 has type H_L and len 204
    initV(z,H_E,vn(x0));
    DOP(vn(x0), vE(z,i)=MUL(0.2,DIV(MUL(vL(x0,i),vE(x1,i)),MUL(vL(x0,i),vL(x2,i))))) R 0;
}
...
E compiled_main(){
    ...
    // getInfoVar(t94); getchar();
    // Variable t94 has type H_L and len 204
