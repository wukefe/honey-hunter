...
L q18_peephole_0(V *z, V y, V *x){
    ...
    initV(z1,vp(x1),lenZ);
    initV(z2,vp(x2),lenZ);
    DOT(len, if(vB(y,i)){L c=offset[tid]++;vLL(z0,c)=vLL(x0,i);vE(z1,c)=vE(x1,i);vD(z2,c)=vD(x2,i);}) R 0;
}
...
E compiled_main(){
    ...
    // getInfoVar(t26);
    // Variable t26 has type H_I and len 6001215
    PROFILE(  8, t28, pfnGroup(t28, t27));  // <-- expensive
    PROFILE(  9, t29, pfnKeys(t29, t28));
    // getInfoVar(t29); getchar();
    // Variable t29 has type H_L and len 1500000
    ...
    PROFILE( 20, t49, pfnMember(t49, t40, t36));
    ...
    // getInfoVar(t103); getInfoVar(t102); getInfoVar(t110); getInfoVar(t114); getInfoVar(t113);
    // Variable t103 has type H_Q and len 399
    // Variable t102 has type H_I and len 399
    // Variable t110 has type H_I and len 399
    // Variable t114 has type H_D and len 399
    // Variable t113 has type H_E and len 399
    PROFILE( 46, t136, pfnGroup(t136, t135));
    PROFILE( 47, t137, pfnKeys(t137, t136));
    // getInfoVar(t137); getchar();
    // Variable t137 has type H_L and len 57
