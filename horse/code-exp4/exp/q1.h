...
L q1_combine_0(V *z, V y, V *x){
    ...
    //P("compress rate: %lld/%lld = %.2lf%%\n", lenZ,len,lenZ*100.0/len); getchar();  // almost 99%
    R 0;
}

L q1_chf_1(V *z, V y, V *x){
    V z0 = z[0]; // t48
    V z1 = z[1]; // t51
    V z2 = z[2]; // t54
    V z3 = z[3]; // t57
    ...
    V z6 = z[6]; // t69
    V z7 = z[7]; // t71
    V x0 = x[0]; // t5 : l_quantity
    V x1 = x[1]; // t6 : l_extendedprice
    V x2 = x[2]; // t7 : l_discount
    V x3 = x[3]; // t8 : l_tax
    V x4 = x[4]; // t11: l_shipdate
    L lenZ = vn(y);
    initV(z0, H_E, lenZ);
    initV(z1, H_E, lenZ);
    initV(z2, H_E, lenZ);
...
E compiled_main(){
    ...
    PROFILE( 12, t40, pfnList(t40, 2, (V []){t9 ,t10}));
    // getInfoVar(t9); getInfoVar(t10); getchar();
    // Variable t9 has type H_C and len 6001215
    // Variable t10 has type H_C and len 6001215
    ...
    // getInfoVar(t42); getInfoVar(t43); getchar();
    // Variable t42 has type H_L and len 4
    // Variable t43 has type H_G and len 4
    //   H_L H_L H_L H_L
    //     total = 4, max = 3004998, min = 38854
    PROFILE( 16, t44, pfnIndex(t44, t9 , t42));  // l_returnflag
    PROFILE( 17, t45, pfnIndex(t45, t10, t42));  // l_linestatus
    PROFILE( 99, t27, q1_chf_1((V []){t48,t51,t54,t57,t60,t63,t69,t71},t43,(V []){t5,t6,t7,t8,t11}));
//    PROFILE( 38, t69, q1_peephole_1((V []){t48,t51,t54,t57,t60,t63,t69}, (V []){t22,t22,t23,t23,t35,t39,t24}, t43));
//    PROFILE( 11, t27, q1_chf_0((V []){t48,t51,t54,t57,t60,t63,t69},(V []){t17,t43},(V []){t5,t6,t7,t8,t9,t10}));
...
//    PROFILE( 40, t71, q1_peephole_2(t71, t43));
    ...
    PROFILE( 46, t77, pfnIndex(t77, t51, t73));
    PROFILE( 47, t78, pfnIndex(t78, t54, t73));
    PROFILE( 48, t79, pfnIndex(t79, t57, t73));
    PROFILE( 49, t80, pfnIndex(t80, t60, t73));
    PROFILE( 50, t81, pfnIndex(t81, t63, t73));
