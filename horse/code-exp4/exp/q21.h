...
L q21_peephole_2(V *z, V y, V *x){
    ...
    //Variable x0 has type H_S and len 75871
    //Variable x1 has type H_I and len 75871
    //Variable x2 has type H_I and len 75871
    L len = vn(y), k = 0;
    L lenZ = 0, parZ[H_CORE], offset[H_CORE];
    DOI(H_CORE, parZ[i]=offset[i]=0)
    CHECKE(getNumOfNonZero(y,parZ));
    ...
    DOT(len, if(vB(y,i)){L c=offset[tid]++;vS(z0,c)=vS(x0,i);vLL(z1,c)=vLL(x1,i);vLL(z2,c)=vLL(x2,i);}) R 0;
}
// Pattern FP3
// Pattern FP4
// Pattern FP5
E compiled_main(){
    ...
    //getInfoVar(t200); getInfoVar(t198); getchar();
    ...
    // getInfoVar(t267);
    // Variable t267 has type H_S and len 4141
    PROFILE( 64, t299, pfnGroup(t299, t298));
    PROFILE( 65, t300, pfnKeys(t300, t299));
    // getInfoVar(t300); getchar();
    // Variable t300 has type H_L and len 411
