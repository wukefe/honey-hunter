...
E compiled_main(){
    ...
    // getInfoVar(t52); getInfoVar(t56); getInfoVar(t59);
    // Variable t52 has type H_I and len 147126
    // Variable t56 has type H_D and len 147126
    // Variable t59 has type H_I and len 147126
    PROFILE( 26, t99, pfnGroup(t99, t98));  // <---
    PROFILE( 27, t100, pfnKeys(t100, t99));
    // getInfoVar(t100); getchar();
    // Variable t100 has type H_L and len 147126
    ...
    // getInfoVar(t79);
    // Variable t79 has type H_I and len 3241776
    PROFILE( 36, t110, pfnGroup(t110, t109));  // <--- expensive
    PROFILE( 37, t111, pfnKeys(t111, t110));
    // getInfoVar(t111); getchar();
    // Variable t111 has type H_L and len 829958
